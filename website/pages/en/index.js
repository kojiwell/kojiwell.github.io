    ...
    return (
      <SplashContainer>
        <div className="inner">
          ...
          <PromoSection>
            <Button href={docUrl('bash.html')}>Notes</Button>
  ...
  render() {
    ...
    const AboutMe = () => (
      <div
	    ...
	    And when I’m not doing any of those, I’m probably writing bits and pieces here. So this place is for a collection 
	    of the stuff I’ve learned along the way as a system guy.</MarkdownBlock>
      </div>
    );
        ...
        {[
          {
            ...
            imageAlign: 'right',
            title: 'What is a high-performance computer?',
          },
        ]}
      </Block>
    );
    ...
    const SysVsSoft = () => (
      <Block background="light">
        {[
          {
            content:
              '"What is the difference between a system engineer and software engineer?" Sometimes people ask me.',
            image: `${baseUrl}img/undraw_youtube_tutorial.svg`,
            imageAlign: 'right',
            title: 'System Engineer vs Software Engineer',
          },
        ]}
      </Block>
    );
